...
export interface ApiLigaLiga extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    uniformes: Schema.Attribute.Relation<'oneToMany', 'api::uniforme.uniforme'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiUniformeUniforme extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    clave: Schema.Attribute.String & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    disponibles: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<1>;
    fotos: Schema.Attribute.Media<'images', true>;
    liga: Schema.Attribute.Relation<'manyToOne', 'api::liga.liga'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::uniforme.uniforme'
    > &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::uniforme.uniforme': ApiUniformeUniforme;
